...
int main() {
    ...
    for (int i = 0; i < n; i++) {
        arr[i] = i; // 0-1000 arasında sıralı sayılar
    }
    ...
    for (int i = 0; i < n; i++) {
        arr[i] = i; // 0-10000 arasında sıralı sayılar
    }
    ...
    for (int i = 0; i < n; i++) {
        arr[i] = i; // 0-50000 arasında sıralı sayılar
    }
    ...
    for (int i = 0; i < n; i++) {
        arr[i] = i; // 0-100000 arasında sıralı sayılar
    }
    ...
    for (int i = 0; i < n; i++) {
        arr[i] = i; // 0-500000 arasında sıralı sayılar
    }
    ...
    for (int i = 0; i < n; i++) {
        arr[i] = i; // 0-1000000 arasında sıralı sayılar
    }

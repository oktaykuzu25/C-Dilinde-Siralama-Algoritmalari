...
int main() {
   int n; // boyut değişkeni
    ...
    for (int i = 0; i < n; i++) {
        arr[i] = rand() % 1000; // 0-1000 arasında rastgele sayılar
    }
        ...
        elapsed_time = ((double)(end - start)) / CLOCKS_PER_SEC * 1000; // Milisaniye cinsinden süre
        printf("insertion Sort ile %d elemanlı dizi sıralama süresi: %.2f ms\n", n, elapsed_time);
       ...
       //mergeshort
        ...
        elapsed_time = ((double)(end - start)) / CLOCKS_PER_SEC * 1000; // Milisaniye cinsinden süre
        printf("merge Sort ile %d elemanlı dizi sıralama süresi: %.2f ms\n", n, elapsed_time);
   ...
   for (int i = 0; i < n; i++) {
        arr[i] = rand() % 10000; // 0-1000 arasında rastgele sayılar
    }
   ...
   for (int i = 0; i < n; i++) {
        arr[i] = rand() % 500000; // 0-1000 arasında rastgele sayılar
    }
     ...
     for (int i = 0; i < n; i++) {
        arr[i] = rand() % 100000; // 0-1000 arasında rastgele sayılar
    }
        // Bubble Sort
        start = clock();
        bubbleSort(arr, n);
    ...
    for (int i = 0; i < n; i++) {
      ...
      for (int i = 0; i < n; i++) {
        arr[i] = rand() % 1000000; // 0-1000 arasında rastgele sayılar
    }
